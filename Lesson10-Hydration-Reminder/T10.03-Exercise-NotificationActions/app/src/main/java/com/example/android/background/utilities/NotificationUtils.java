...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_PENDINGINTENT_ID = 100;
    private static final int ACTION_IGNORE_PENDINGINTENT_ID =  101;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent pendingIntend = PendingIntent.getService(
                context, ACTION_IGNORE_PENDINGINTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT
        );
        NotificationCompat.Action ignoreReminderAction =
                new NotificationCompat.Action(R.drawable.ic_cancel_black_24px,
                        "No, thanks.", pendingIntend);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context){
        ...
        PendingIntent pendingIntend = PendingIntent.getService(
                context, ACTION_DRINK_PENDINGINTENT_ID, intent, PendingIntent.FLAG_UPDATE_CURRENT
        );
