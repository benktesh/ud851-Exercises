...
public class ReminderTasks {
    ...
    public static final String ACTION_CHARGING_REMINDER = "charing-reminder";
    ...
    private static void issueChargingReinder(Context context){
